	...
	@Entity
	@Table(name="configuration.whl_category_lang_params")
	public class WhlCategoryLangParam implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "whl_category_lang_param";
	static final String type = "WhlCategoryLangParam";
	...
	//public static final String ref = "whl_category_lang_param_id";
	...
	//fill DbE
		...
		DbE.put("whl_category_lang_param_id", "id");
	...
	@Id
	@Column(name="whl_category_lang_param_id")
		
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="whl_category_lang_params_whl_category_lang_param_id_seq")
	@SequenceGenerator(name="whl_category_lang_params_whl_category_lang_param_id_seq", sequenceName="configuration.whl_category_lang_params_whl_category_lang_param_id_seq")
