	...
	@Entity
	@Table(name="configuration.event_types")
	public class EventType implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "event_type";
	...
	//public static final String ref = "event_type_id";
	...
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="event_types_event_type_id_seq")
	@SequenceGenerator(name="event_types_event_type_id_seq", sequenceName="configuration.event_types_event_type_id_seq")
