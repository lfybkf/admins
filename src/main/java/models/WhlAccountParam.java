	...
	@Entity
	@Table(name="configuration.whl_account_params")
	public class WhlAccountParam implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "whl_account_param";
	static final String type = "WhlAccountParam";
	...
	//public static final String ref = "whl_account_param_id";
	...
	//fill DbE
		...
		DbE.put("whl_account_param_id", "id");
	...
	@Id
	@Column(name="whl_account_param_id")
		
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="whl_account_params_whl_account_param_id_seq")
	@SequenceGenerator(name="whl_account_params_whl_account_param_id_seq", sequenceName="configuration.whl_account_params_whl_account_param_id_seq")
