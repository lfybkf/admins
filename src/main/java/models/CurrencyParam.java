	...
	@Entity
	@Table(name="configuration.currency_params")
	public class CurrencyParam implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "currency_param";
	static final String type = "CurrencyParam";
	...
	//public static final String ref = "currency_param_id";
	...
	@Id
	@Column(name="currency_param_id")
		
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="currency_params_currency_param_id_seq")
	@SequenceGenerator(name="currency_params_currency_param_id_seq", sequenceName="configuration.currency_params_currency_param_id_seq")
