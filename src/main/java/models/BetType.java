	...
	@Entity
	@Table(name="configuration.bet_types")
	public class BetType implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "bet_type";
	static final String type = "BetType";
	...
	//public static final String ref = "bet_type_id";
	...
	//fill DbE
		...
		DbE.put("bet_type_id", "id");
	
		DbE.put("code", "code");
	
		DbE.put("name", "name");
	
		DbE.put("client_code", "client_code");
	...
	String value;
		...
		value = Utils.getFirst(values.get("client_code"));
		
		if (value != null)
		{
		
				this.setClient_code(Integer.parseInt(value));
	...
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="bet_types_bet_type_id_seq")
	@SequenceGenerator(name="bet_types_bet_type_id_seq", sequenceName="configuration.bet_types_bet_type_id_seq")
	...
	//fields =====================
			...
			public Integer getClient_code() {return client_code;} //getter
			public void setClient_code(Integer arg_value) {client_code = arg_value;} //setter
