	...
	@Entity
	@Table(name="configuration.providers")
	public class Provider implements app.IEntity
	{

	private static final long serialVersionUID = 2L;
	static final String ident = "provider";
	...
	//public static final String ref = "provider_id";
	...
	@SequenceGenerator(name="providers_provider_id_seq", sequenceName="configuration.providers_provider_id_seq")
