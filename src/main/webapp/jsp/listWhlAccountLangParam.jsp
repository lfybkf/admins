...
<html>
<head>
<title>list:WhlAccountLangParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlAccountLangParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlAccountLangParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlAccountLangParam.takeUrlCreate())</jsp:expression>
...
for (Object obj: ents ) {
WhlAccountLangParam ent = (WhlAccountLangParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
