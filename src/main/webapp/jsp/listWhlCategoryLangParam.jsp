...
<html>
<head>
<title>list:WhlCategoryLangParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlCategoryLangParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlCategoryLangParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlCategoryLangParam.takeUrlCreate())</jsp:expression>
...
<th class="lang" width="*" xmlns=""><a href="?order=lang">lang</a></th>
<th class="value" width="*" xmlns=""><a href="?order=value">value</a></th>
<th class="whl_category_id" width="*" xmlns=""><a href="?order=whl_category_id">WhlCategory</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
for (Object obj: ents ) {
WhlCategoryLangParam ent = (WhlCategoryLangParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
...
<td xmlns=""><jsp:expression>ent.getLang()</jsp:expression></td>
<td xmlns=""><jsp:expression>ent.getValue()</jsp:expression></td>
<td xmlns=""><jsp:scriptlet>
EntityRef = ent.getWhl_category_id();
