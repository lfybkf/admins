...
<html>
<head>
<title>list:AuthTypeParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">AuthTypeParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="AuthTypeParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + AuthTypeParam.takeUrlCreate())</jsp:expression>
...
<th class="auth_type_id" width="*" xmlns=""><a href="?order=auth_type_id">AuthType</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
for (Object obj: ents ) {
AuthTypeParam ent = (AuthTypeParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
