...
<html>
<head>
<title>list:Provider<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">Provider<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="Provider">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + Provider.takeUrlCreate())</jsp:expression>
