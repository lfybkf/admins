...
<jsp:useBean id="entity" type="models.WhiteLabel" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="is_blocked">is_blocked</label></td>
<td><jsp:expression>
tag.clear().setId("is_blocked").setName("is_blocked").setClass(Html.CLASS_LARGE).setReadonly("")
	.setChecked(entity.getIs_blocked()).buildCheckbox()
				</jsp:expression></td>
</tr>
</table>
