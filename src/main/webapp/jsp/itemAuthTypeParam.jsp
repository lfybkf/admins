...
<jsp:useBean id="entity" type="models.AuthTypeParam" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="auth_type_id"><jsp:scriptlet>
ClassRef = "AuthType";
EntityRef = entity.getAuth_type_id();
...
<td><jsp:scriptlet>link = Linkistry.findOnNameAndChild("all", "auth_type");</jsp:scriptlet><jsp:expression>
tag.clear().setId("auth_type_id").setName("auth_type_id").setClass(Html.CLASS_LARGE).setReadonly("")
	.setEntity(entity.getAuth_type_id()).buildSelect(link)
</jsp:expression></td>
</tr>
</table>
