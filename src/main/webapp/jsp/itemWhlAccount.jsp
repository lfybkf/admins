...
<jsp:useBean id="entity" type="models.WhlAccount" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="url">url</label></td>
<td><jsp:expression>
tag.clear().setId("url").setName("url").setClass(Html.CLASS_LARGE).setReadonly("")
	.setValue(entity.getUrl()).buildText()
				</jsp:expression></td>
</tr>
<tr xmlns="">
<td width="15%"><label for="description">description</label></td>
<td><jsp:expression>
tag.clear().setId("description").setName("description").setClass(Html.CLASS_LARGE).setReadonly("")
	.setValue(entity.getDescription()).buildText()
				</jsp:expression></td>
</tr>
<tr xmlns="">
