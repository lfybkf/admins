...
<html>
<head>
<title>list:WhlAccountParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlAccountParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlAccountParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlAccountParam.takeUrlCreate())</jsp:expression>
...
for (Object obj: ents ) {
WhlAccountParam ent = (WhlAccountParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
