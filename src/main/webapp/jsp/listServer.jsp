...
<html>
<head>
<title>list:Server<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">Server<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="Server">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + Server.takeUrlCreate())</jsp:expression>
...
<th class="address" width="*" xmlns=""><a href="?order=address">address</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
<td xmlns=""><jsp:expression>ent.getAddress()</jsp:expression></td>
</tr>
<jsp:scriptlet>}</jsp:scriptlet>
</tbody>
</table>
