...
<jsp:useBean id="entity" type="models.WhlCategoryLangParam" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="whl_category_id"><jsp:scriptlet>
ClassRef = "WhlCategory";
EntityRef = entity.getWhl_category_id();
...
tag.clear().setId("whl_category_id").setName("whl_category_id").setClass(Html.CLASS_LARGE).setReadonly("")
	.setEntity(entity.getWhl_category_id()).buildSelect(link)
</jsp:expression></td>
</tr>
</table>
