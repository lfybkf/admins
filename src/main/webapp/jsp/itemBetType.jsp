...
<jsp:useBean id="entity" type="models.BetType" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="client_code">client_code</label></td>
<td><jsp:expression>
tag.clear().setId("client_code").setName("client_code").setClass(Html.CLASS_LARGE).setReadonly("")
	.setValue(entity.getClient_code()).buildText()
				</jsp:expression></td>
</tr>
<tr xmlns="">
