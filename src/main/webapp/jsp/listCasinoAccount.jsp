...
<html>
<head>
<title>list:CasinoAccount<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">CasinoAccount<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="CasinoAccount">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + CasinoAccount.takeUrlCreate())</jsp:expression>
...
<th class="integration_code" width="*" xmlns=""><a href="?order=integration_code">integration_code</a></th>
<th class="component_code" width="*" xmlns=""><a href="?order=component_code">component_code</a></th>
<th class="is_valid" width="*" xmlns=""><a href="?order=is_valid">is_valid</a></th>
<th class="is_active" width="*" xmlns=""><a href="?order=is_active">is_active</a></th>
<th class="provider_id" width="*" xmlns=""><a href="?order=provider_id">Provider</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
for (Object obj: ents ) {
CasinoAccount ent = (CasinoAccount)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
...
<td xmlns=""><jsp:expression>ent.getIntegration_code()</jsp:expression></td>
<td xmlns=""><jsp:expression>ent.getComponent_code()</jsp:expression></td>
<td xmlns=""><jsp:expression>ent.getIs_valid()</jsp:expression></td>
<td xmlns=""><jsp:expression>ent.getIs_active()</jsp:expression></td>
<td xmlns=""><jsp:scriptlet>
EntityRef = ent.getProvider_id();
