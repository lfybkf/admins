...
<html>
<head>
<title>list:WhlWalletType<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlWalletType<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlWalletType">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlWalletType.takeUrlCreate())</jsp:expression>
...
<th class="wallet_type_id" width="*" xmlns=""><a href="?order=wallet_type_id">WalletType</a></th>
...
for (Object obj: ents ) {
WhlWalletType ent = (WhlWalletType)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
...
EntityRef = ent.getWallet_type_id();
