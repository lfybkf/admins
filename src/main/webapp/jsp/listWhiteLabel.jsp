...
<html>
<head>
<title>list:WhiteLabel<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhiteLabel<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhiteLabel">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhiteLabel.takeUrlCreate())</jsp:expression>
...
<th class="is_blocked" width="5%" xmlns=""><a href="?order=is_blocked">is_blocked</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
<td xmlns=""><jsp:expression>ent.getIs_blocked()</jsp:expression></td>
</tr>
<jsp:scriptlet>}</jsp:scriptlet>
</tbody>
</table>
