...
<jsp:useBean id="entity" type="models.WhlCategory" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="whl_category_id_parent"><jsp:scriptlet>
ClassRef = "WhlCategory";
EntityRef = entity.getWhl_category_id_parent();
...
<td><jsp:scriptlet>link = Linkistry.findOnNameAndChild("all", "whl_category");</jsp:scriptlet><jsp:expression>
tag.clear().setId("whl_category_id_parent").setName("whl_category_id_parent").setClass(Html.CLASS_LARGE).setReadonly("")
	.setEntity(entity.getWhl_category_id_parent()).buildSelect(link)
</jsp:expression></td>
</tr>
<tr xmlns="">
