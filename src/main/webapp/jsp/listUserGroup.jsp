...
<html>
<head>
<title>list:UserGroup<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">UserGroup<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="UserGroup">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + UserGroup.takeUrlCreate())</jsp:expression>
...
<th class="code" width="15%" xmlns=""><a href="?order=code">code</a></th>
<th class="whl_id" width="15%" xmlns=""><a href="?order=whl_id">WhiteLabel</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
