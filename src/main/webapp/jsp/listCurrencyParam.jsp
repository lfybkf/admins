...
<html>
<head>
<title>list:CurrencyParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">CurrencyParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="CurrencyParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + CurrencyParam.takeUrlCreate())</jsp:expression>
...
for (Object obj: ents ) {
CurrencyParam ent = (CurrencyParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
