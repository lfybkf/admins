...
<jsp:useBean id="entity" type="models.WhlWalletTypeParam" scope="request"/>
<jsp:scriptlet>
...
<tr xmlns="">
<td width="15%"><label for="whl_wallet_type_id"><jsp:scriptlet>
ClassRef = "WhlWalletType";
EntityRef = entity.getWhl_wallet_type_id();
...
<td><jsp:scriptlet>link = Linkistry.findOnNameAndChild("all", "whl_wallet_type");</jsp:scriptlet><jsp:expression>
tag.clear().setId("whl_wallet_type_id").setName("whl_wallet_type_id").setClass(Html.CLASS_LARGE).setReadonly("")
	.setEntity(entity.getWhl_wallet_type_id()).buildSelect(link)
</jsp:expression></td>
</tr>
</table>
