...
<html>
<head>
<title>list:WhlCategory<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlCategory<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlCategory">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlCategory.takeUrlCreate())</jsp:expression>
...
for (Object obj: ents ) {
WhlCategory ent = (WhlCategory)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
