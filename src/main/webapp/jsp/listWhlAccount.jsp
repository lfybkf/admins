...
<html>
<head>
<title>list:WhlAccount<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlAccount<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlAccount">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlAccount.takeUrlCreate())</jsp:expression>
...
<th class="casino_account_id" width="*" xmlns=""><a href="?order=casino_account_id">CasinoAccount</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
<td xmlns=""><jsp:scriptlet>
EntityRef = ent.getCasino_account_id();
</jsp:scriptlet><jsp:expression>(EntityRef != null) ? tag.clear().buildHref (appPath + EntityRef.getUrlEdit(), EntityRef) : Const.REF_EMPTY</jsp:expression></td>
</tr>
<jsp:scriptlet>}</jsp:scriptlet>
</tbody>
