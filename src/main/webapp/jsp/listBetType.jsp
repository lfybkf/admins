...
<html>
<head>
<title>list:BetType<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">BetType<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="BetType">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + BetType.takeUrlCreate())</jsp:expression>
...
<th class="client_code" width="*" xmlns=""><a href="?order=client_code">client_code</a></th>
...
<td xmlns=""><jsp:expression>ent.getClient_code()</jsp:expression></td>
