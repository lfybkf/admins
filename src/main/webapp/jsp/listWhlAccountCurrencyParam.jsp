...
<html>
<head>
<title>list:WhlAccountCurrencyParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlAccountCurrencyParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlAccountCurrencyParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlAccountCurrencyParam.takeUrlCreate())</jsp:expression>
...
<th class="value" width="*" xmlns=""><a href="?order=value">value</a></th>
<th class="whl_account_id" width="*" xmlns=""><a href="?order=whl_account_id">WhlAccount</a></th>
<th class="user_group_id" width="*" xmlns=""><a href="?order=user_group_id">UserGroup</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
for (Object obj: ents ) {
WhlAccountCurrencyParam ent = (WhlAccountCurrencyParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
...
<td xmlns=""><jsp:expression>ent.getValue()</jsp:expression></td>
<td xmlns=""><jsp:scriptlet>
EntityRef = ent.getWhl_account_id();
...
<td xmlns=""><jsp:scriptlet>
EntityRef = ent.getUser_group_id();
</jsp:scriptlet><jsp:expression>(EntityRef != null) ? tag.clear().buildHref (appPath + EntityRef.getUrlEdit(), EntityRef) : Const.REF_EMPTY</jsp:expression></td>
</tr>
<jsp:scriptlet>}</jsp:scriptlet>
</tbody>
