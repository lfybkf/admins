...
<html>
<head>
<title>list:WhlWalletTypeParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlWalletTypeParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlWalletTypeParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlWalletTypeParam.takeUrlCreate())</jsp:expression>
...
<th class="whl_wallet_type_id" width="*" xmlns=""><a href="?order=whl_wallet_type_id">WhlWalletType</a></th>
</tr>
</thead>
<tbody>
<jsp:scriptlet>
...
for (Object obj: ents ) {
WhlWalletTypeParam ent = (WhlWalletTypeParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
...
EntityRef = ent.getWhl_wallet_type_id();
