...
<html>
<head>
<title>list:WhlCategoryParam<jsp:expression>master_info</jsp:expression></title>
...
<div id="main">
<h1 align="center">WhlCategoryParam<span id="master_info"><jsp:expression>master_info_href</jsp:expression></span></h1>
<table class="zebra-striped entity-list" id="WhlCategoryParam">
<thead>
<tr>
<th class="link_action" width="10%">
<jsp:expression>tag.clear().buildFormOpen(appPath + WhlCategoryParam.takeUrlCreate())</jsp:expression>
...
for (Object obj: ents ) {
WhlCategoryParam ent = (WhlCategoryParam)obj;
</jsp:scriptlet>
<tr>
<td>
<ul class="goto_menu">
